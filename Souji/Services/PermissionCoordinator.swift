...
/// - Auto-opens the Settings pane and reveals Souji.app in Finder so users can
...
final class PermissionCoordinator: ObservableObject {
    ...
    /// Open System Settings AND reveal Souji.app in Finder so the user can
    ...
    /// Reset Souji's TCC entry and re-prime registration. Use when the user
    /// reports Souji doesn't appear in the FDA list (typical after Homebrew
