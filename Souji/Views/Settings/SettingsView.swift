...
struct GeneralSettingsView: View {
    ...
    var body: some View {
        Form {
            Section("Startup") {
                Toggle("Launch Souji at login", isOn: launchAtLoginBinding)
            }
            ...
            Section("Language") {
                ...
                if languageNeedsRelaunch {
                    Text("Restart Souji to apply the selected language.")
                        .font(.caption)
                        .foregroundStyle(.secondary)
            ...
            Section("System Monitor") {
                ...
                Text("Live CPU, memory, and disk meters in the menu bar. Souji keeps running in the background while this is on.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
    ...
    private func relaunchApp() {
        ...
        do {
            ...
            Logger.shared.log("Failed to relaunch Souji: \(error.localizedDescription)", level: .error)
        }
    }
}
