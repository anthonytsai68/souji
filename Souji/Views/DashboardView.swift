...
struct DashboardView: View {
    ...
    private var headerSubtitle: String {
        ...
        case .scanning:
            return String(localized: "Souji is checking your Mac without removing anything.")
        case .completed:
        ...
        return SmartCareStageSurface(
            ...
            HStack(spacing: compact ? 14 : 28) {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("Souji builds a reviewable cleanup plan on your Mac. Nothing is removed until you approve it.")
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    if isClean {
                        Text("Your Mac is in good shape.")
                            ...
                            .tracking(-0.6)
                            .foregroundStyle(.white)
                        Text("No removable junk was found in the areas Souji checked.")
                            .font(.system(size: 14))
                            .foregroundStyle(.white.opacity(0.68))
                    } else {
