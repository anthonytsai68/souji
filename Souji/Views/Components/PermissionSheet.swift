...
/// and offers escape hatches for the "Souji isn't in the list" case.
struct PermissionSheet: View {
    ...
    private var requestBody: some View {
        VStack(alignment: .leading, spacing: 18) {
            // Two paths the user can choose between: drag the Souji bundle
            ...
            HStack(alignment: .center, spacing: 14) {
                ...
                VStack(spacing: 8) {
                    Button {
                        ...
                        Label("Open Settings & reveal Souji", systemImage: "gear")
            ...
            // Step-by-step strip
            HStack(spacing: 0) {
                stepCell(number: 1, title: "Turn on Souji",
            ...
            HStack(spacing: 8) {
                ...
                Text("Watching for permission change…")
                    ...
                    .foregroundStyle(.secondary)
                Spacer()
                Button(showAdvanced ? "Hide help" : "Souji not in the list?") {
    ...
    private var advancedPanel: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text("Try this if Souji doesn't appear:")
            ...
            HStack(spacing: 8) {
                advancedButton(
                    ...
                    title: "Reveal app",
                    subtitle: "Drag Souji.app into the list"
                ) {
